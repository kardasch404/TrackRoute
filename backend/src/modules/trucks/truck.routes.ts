...
router.post('/', rbacMiddleware([Permission.TRUCK_CREATE]), validationMiddleware(createTruckSchema), truckController.createTruck);
...
router.put('/:id', rbacMiddleware([Permission.TRUCK_UPDATE]), validationMiddleware(updateTruckSchema), truckController.updateTruck);
